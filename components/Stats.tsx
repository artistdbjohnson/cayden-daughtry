  ...
  return (
    <section id="stats" className="relative py-24 md:py-32 px-6 md:px-12 lg:px-20 bg-paper text-ink">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="font-display text-4xl md:text-6xl font-black tracking-tighter mb-4">
          THE NUMBERS
        </h2>
        <p className="text-muted text-lg mb-16 max-w-xl">
          Film is one thing. The box score is another. Both say the same thing.
        </p>
        ...
        {/* Cascade grid — intentional asymmetry */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          <div className="md:col-span-5 p-6 md:p-8 rounded-2xl bg-surface border border-ink/5">
            ...
            <p className="font-display text-5xl font-black text-ice mb-1">
              <AnimatedNumber value={26.5} />
            </p>
          ...
          <div className="md:col-span-7 p-6 md:p-8 rounded-2xl bg-surface border border-ink/5">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div>
                <p className="font-display text-3xl font-black text-ice"><AnimatedNumber value={58.6} suffix="%" decimals={1} /></p>
                <p className="text-xs text-muted mt-1">FG</p>
              </div>
              <div>
                <p className="font-display text-3xl font-black text-ice"><AnimatedNumber value={48.8} suffix="%" decimals={1} /></p>
                <p className="text-xs text-muted mt-1">3PT</p>
              </div>
              <div>
                <p className="font-display text-3xl font-black text-heat"><AnimatedNumber value={91} suffix="%" decimals={0} /></p>
                <p className="text-xs text-muted mt-1">FT</p>
              </div>
            </div>
          ...
          <div className="md:col-span-4 p-6 md:p-8 rounded-2xl bg-surface border border-ink/5">
            ...
            <p className="font-display text-4xl font-black text-ice mb-1">
              <AnimatedNumber value={11.7} />
            </p>
          ...
          <div className="md:col-span-8 p-6 md:p-8 rounded-2xl border border-ice/20 bg-ice/5">
            ...
            <p className="text-xl md:text-2xl font-medium text-ink leading-snug">
              High motor. Elite handle. Cold-blooded finishing. The numbers are not the story — they are the proof.
            </p>
          </div>
        </div>
      </div>
