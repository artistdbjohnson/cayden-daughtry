...
const offers = [
  'Kentucky', 'Miami', 'Michigan', 'Louisville', 'Florida',
  'FSU', 'Iowa', 'UConn', 'LSU', 'Cincinnati', 'BYU',
]
    ...
    <section id="recognition" className="relative py-24 md:py-32 px-6 md:px-12 lg:px-20 bg-surface">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="font-display text-4xl md:text-6xl font-black tracking-tighter mb-12"
        >
          Recognition
        </motion.h2>
